...
public class MenuConstantes {
    ...
    public static final String OPCION_VOLVER = "Volver al menú anterior";
    public static final String OPCION_INVALIDA = "Opción no válida. Inténtelo de nuevo.";
    public static final String VER_TODOS_LIBROS = "Ver todos los libros";
    public static final String VER_TODAS_NOVELAS = "Ver todas las novelas";
